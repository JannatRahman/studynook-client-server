...
const AvailableStudyRoomsCard = ({ studyrooms }) => {
  return (
    <div
      ...
      <div className="absolute right-5 top-5 z-20">
        <div
          className=" flex h-10 w-10 items-center justify-center rounded-full bg-white/60 backdrop-blur-md  transition-all duration-300 group-hover:rotate-12 group-hover:scale-110 ">
          <MoveUpRight
            size={18}
      ...
      <div className="relative z-10 mt-5 space-y-4 text-center">
        <div className="space-y-2">
          <h2
            className="text-xl sm:text-2xl font-bold tracking-tight   text-gray-800">
            {studyrooms?.name}
          </h2>

          <p
            className="line-clamp-2 text-sm sm:text-base leading-relaxed text-gray-600">
 ...
 font-medium text-gray-700 backdrop-blur-md">
            {studyrooms?.floor}
          </span>

          <span
            className=" rounded-full bg-[#84B179] px-4 py-1.5 text-xs sm:text-sm font-semibold  text-white" >
        ...
        <div className="flex items-center gap-3 pt-2">
          <Link
            ...
            className="flex-1 rounded-2xl bg-[#84B179] px-4 py-3 text-center text-sm sm:text-base  font-semibold  text-white shadow-lg shadow-[#84B179]/30 transition-all duration-300 hover:scale-[1.03]hover:bg-[#739f68] active:scale-95">
            View Details
          </Link>
